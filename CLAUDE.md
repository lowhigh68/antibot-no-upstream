...
| Layer | Path | Role |
|---|---|---|
| core | `core/config.lua`, `redis_pool.lua`, `req_classifier.lua`, `session_richness.lua`, `cookie_registry.lua`, `goodbot_seed.lua`, `data/goodbot.json` | Thresholds, Redis pool, classification, bằng chứng phiên, sổ tên cookie theo host, good-bot registry seed |
